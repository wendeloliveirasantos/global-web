export const insuranceInformation = {
  ...
  advantages: [
    {
      title: `Roubo e furto`,
      description: `Passar por uma situação dessa já não é a situação mais legal, então precisamos estar protegidos para 
              além de tudo não ficar no prejuízo. Com essa cobertura você garante que caso o seu carro seja furtado ou 
              roubado você receberá a indenização (conforme as informações do seu contrato).`,
      coverage: `Quais são as condições para cobertura?`,
      items: [
        `caso o seu carro não seja encontrado no período determinado pelo contrato;`,
        `você recebe a indenização integral do seguro se o custo do conserto ultrapassar 75% do valor do carro, 
    ...
    },
    {
      ...
      description: `Se envolver em uma batida já é algo que dá um susto, então a gente não precisa levar outro só 
          de pensar no valor da conta da oficina, né? Esse seguro garante que você estará coberto em caso de acidentes 
          (colisão, capotamento etc.). Mas e se der PT? Você também não terá que se preocupar com isso. Você receberá 
          o valor que está lá acordado na sua apólice.`,
      coverage: `Quais são as condições para cobertura?`,
      items: [
        `se acontecer um acidente e o valor do concerto custar mais que o valor da franquia;`,
        `se o carro for encontrado depois de um roubo danificado;`,
        `em caso de eventos naturais;`,
        `a cobertura leva em conta acidentes como batidas, capotagens e queda do veículo;`,
        `em caso de PT você recebe a indenização integral do seguro se o custo do conserto ultrapassar 75% do valor do carro, de acordo com a Tabela Fipe;`
      ],
      more: `Mais informações você encontra nas Condições Gerais do seguro auto.`
    },
    {
      title: `Alagamento e eventos da natureza`,
      description: `A chuva apertou, a árvore caiu, a água subiu e agora? Fique tranquilo, caso eventos naturais 
              te peguem de surpresa e aconteça qualquer coisa, o seu carro está protegido.`,
      coverage: `Quais são as condições para cobertura?`,
      items: [
        `além de alagamento, o seguro cobre também inundação, granizo, ressaca, ventos fortes e outros eventos naturais com velocidade igual ou acima de 54 km/h;`,
        `em caso de PT você recebe a indenização integral do seguro se o custo do conserto ultrapassar 75% do valor do carro, de acordo com a Tabela Fipe;`,
        `esses eventos naturais podem estar cobertos em caso de contratação contra colisão, consulte sua apólice.`
      ],
      more: `Mais informações você encontra nas Condições Gerais do seguro auto.`
    },
    {
      title: `Incêndio`,
      description: `Corre que tá pegando fogo! Com essa cobertura você garante a indenização em caso de acidentes com fogo 
              ou se um incêndio detonar o seu carro. Na hora de montar seu seguro é importante considerar essa 
              cobertura para não ter dor de cabeça.`,
      coverage: `Quais são as condições para cobertura?`,
      items: [
        `deixa seu carro protegido em caso de explosão acidental e queda de raios;`,
        `a cobertura considera apenas acidentes;`,
        `em caso de PT você recebe a indenização integral do seguro se o custo do conserto ultrapassar 75% do 
              valor do carro, de acordo com a Tabela Fipe;`
      ],
      more: `Mais informações você encontra nas Condições Gerais do seguro auto.`
    },
    {
      title: `Danos corporais a terceiros`,
      description: `Me envolvi em um acidente com outras pessoas, e agora? Essa cobertura te ajuda nas despesas que podem 
              surgir seja com médicos, internações, exames e até advogados.`,
      coverage: `Quais são as condições para cobertura?`,
      items: [
        `caso o seu carro não seja encontrado no período determinado pelo contrato;`,
        `você recebe a indenização integral do seguro se o custo do conserto ultrapassar 75% do valor do carro, 
    ...
    },
    {
      ...
      description: `Aiii, bateu! Estava dirigindo e bate em outra pessoa, ou bati em um muro, o que eu faço? Além 
          da preocupação e do susto, isso envolve custos. Com essa cobertura você garante que as despesas que tiver 
          com reparos, reposições e até mesmo com advogados estarão garantidas. `,
      coverage: `Quais são as condições para cobertura?`,
      items: [
        `você define o valor que gostaria de receber como indenização se isso acontecer, para cobrir os 
              prejuízos que tiver;`,
        `acidentes com cargas e atropelamentos entram nessa cobertura, desde que o veículo de transporte seja 
              adequado ao produto transportado;`
      ],
      more: `Mais informações você encontra nas Condições Gerais do seguro auto.`
    },
    {
      title: `Acidentes de passageiros com despesas médicas e hospitalares`,
      description: `Com o trânsito estressante e agitado dos dias de hoje, estamos vulneráveis a qualquer tipo de 
              acidente e queremos garantir a segurança de todos. Essa cobertura garante que em um acidente se os passageiros 
              do veículo se ferirem ou se alguém falecer, você receberá a indenização contratada, tanto por uma possível 
              invalidez ou por morte, dos passageiros que estiverem no carro.`,
      coverage: `Quais são as condições para cobertura?`,
      items: [
        `você define o valor que gostaria de receber como indenização se isso acontecer, para cobrir os prejuízos que tiver;`,
        `poderá ser contratada incluindo a previsão de despesas médicas e hospitalares, devidamente comprovadas;`,
        `todo mundo é considerado passageiro, até o motorista;`,
        `na hora da indenização a lotação máxima do veículo é considerada;`
      ],
      more: `Mais informações você encontra nas Condições Gerais do seguro auto.`
    }
  ],
